...
/**
 * @typedef {Object} DataGroupTools - Liste des dataSheet
 * @property {string} DataGroupTools.id - Largeur maximal du layou
 * @property {'radio'|'radioButton'|'switch'|'switchButton'|'button'} DataGroupTools.type - Largeur maximal du layou
 * @property {Array.<string>} DataGroupTools.actived - Largeur maximal du layou
 * @property {Array.<DataTool>} DataGroupTools.children - Largeur maximal du layou

 */
/**
 * @typedef {Object} DataTool - Liste des dataSheet
 * @property {string} DataTool.id - Largeur maximal du layou
 * @property {any} DataTool.icon - Largeur maximal du layou
 * @property {string} DataTool.desc - Largeur maximal du layou
 */
/** Store des tools */
