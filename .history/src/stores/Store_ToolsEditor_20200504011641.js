...
/**
 * @typedef {'radio'|'radioButton'|'switch'|'switchButton'|'button'} MEDIA_TYPE_FLASH
 */

/**
 * @typedef {Object} DataGroupTools - Desc
 * @property {string} DataGroupTools.id - Desc
 * @property {'radio'|'radioButton'|'switch'|'switchButton'|'button'} [type] - Desc
 * @property {Array.<string>} DataGroupTools.actived - Desc
...
var FakeStore_TestType = {
	/**@type {DataGroupTools} */
	key: {
		id: 'editors',
		type: "'radio' | 'radioButton' | 'switch' | 'switchButton' | 'button'",
		actived: ['selectRec'],
		children: [],
	},
};
FakeStore_TestType;
export const Store_TestType = store({
	data: {
		/**@type {DataGroupTools} */
		editors: {
			id: 'editors',
