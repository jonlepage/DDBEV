 ...
 * @property {boolean} DataGroupTool.id - Largeur maximal du layou
 * @property {string} DataGroupTool.type - Largeur maximal du layou
 * @property {string} DataGroupTool.actived - Largeur maximal du layou
