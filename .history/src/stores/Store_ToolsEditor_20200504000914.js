 ...
 * @property {boolean} dataSheet.id - Largeur maximal du layou
 * @property {string} dataSheet.type - Largeur maximal du layou
 * @property {string} dataSheet.actived - Largeur maximal du layou
