 ...
 * @property {errorTypes} typess - Desc ('radio'|'radioButton'|'switch'|'switchButton'|'button')
...
export const Store_ToolsEditor = store({
	type:{radio:"radio",'radioButton':"radioButton",'switch':"switch",'switchButton':"switchButton",'button':"button"}
	/** Le zoom Actuel*/
	_zoomValue: 1,
	data: {
