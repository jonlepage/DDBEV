...
const LayoutBox = ({ id, transformScale }) => {
	const { id } = Store_PageOnglets.getCurrentSelected(); // on extract le id de la page afficher
	const { id } = Store_PageOnglets.getCurrentSelected(); // on extract le id du content
