	...
	if (id > 0) {
		return (
			<GridLayout
                ...
                linear-gradient(to left, ${gridColor}  ${gridThickness}, transparent 1px),
                linear-gradient(to top, ${gridColor}  ${gridThickness}, transparent 1px),
                linear-gradient(to bottom, ${gridColor}  ${gridThickness}, transparent 1px)`,
				}}
