		...
		<>
			...
			>
				<Box display='flex' bgcolor='grey.700'>
					<Box px={1} bgcolor='grey.500'>
						file
					</Box>
					<Box px={1} bgcolor='grey.400'>
						edition
					</Box>
					<Box px={1} bgcolor='grey.300'>
						help
					</Box>
				</Box>
				<Box
				...
				<Box
					...
					bgcolor='grey.900'
				>
					<Box px={2} mx={0} bgcolor='grey.500'>
						_
					</Box>
					<Box px={2} mx={0} bgcolor='grey.400'>
						[]
					</Box>
					<Box px={2} mx={0} bgcolor='grey.300'>
						X
					</Box>
				</Box>
			</Box>
			...
			{/* panel control*/}
			<Box display='flex' height='100%' minHeight='0px' bgcolor='grey.400'>
				content
			</Box>
			{/* <body />  css={{	'min-height': '0px', height: '100%' }}*/}

			{/* <Footer /> */}
			<Box display='flex' justifyContent='flex-end' bgcolor='grey.900'>
				<Box display='flex' p={p} bgcolor='grey.700'>
					<Box px={1} mx={1} bgcolor='grey.500'>
						coord
					</Box>
					<Box px={1} mx={1} bgcolor='grey.400'>
						action info
					</Box>
					<Box px={1} mx={1} bgcolor='grey.300'>
						loading
					</Box>
				</Box>
				<Box
			...
			<div className='ContentTool'>Tool</div>
