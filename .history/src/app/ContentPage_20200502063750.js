...
const ContentPage = () => {
	...
	const ruleLabels = Array.from({ length: width / cols }, (x, i) => (
		<label style={{ width: `${width / cols}` }} key={i}>
			{i}
		</label>
	));
	console.log('ruleLabels: ', ruleLabels);
	return (
		<>
					...
					{({
						...
						<TransformComponent>
							<div
								className='Ruller'
								style={{
									transform: `translate3d(${-0}px, ${-positionY}px, 0px)`,
